...
export const DATA = {
  ...
  categories: [
    {
      ...
      description: "Explore our digital menus and flavorful designs — crafted for restaurants and cafés that deserve to stand out.",
      descriptionAr: "شاهد بعض مشاريعنا في عالم الطعام والمذاق الرقمي.",
    },
    {
      id: "ecommerce",
      emoji: undefined,
      ...
      description: "From cart to checkout — see how we build fast, elegant, and profitable online stores.",
      descriptionAr: "تصفح مشاريعنا في عالم التجارة الإلكترونية وجرّب تجربة الشراء السلسة اللي بنصممها لعملائنا.",
    },
    {
      id: "companies",
      emoji: "🏭",
      ...
      titleAr: "الشركات والخدمات",
      description: "We turn company profiles into powerful digital identities — discover how we help businesses grow.",
      descriptionAr: "اكتشف مواقع الشركات اللي صممناها لتظهر بشكل احترافي وتكسب ثقة العملاء.",
    },
    {
      id: "beauty",
      emoji: "💄",
      icon: undefined,
      title: "Beauty, Cosmetics & Clinics",
      titleAr: "التجميل ومستحضرات العناية",
      description: "Beauty meets design — explore elegant websites for cosmetics and beauty brands.",
      descriptionAr: "تصفح مشاريعنا في عالم الجمال والعناية اللي بتجمع بين الفخامة والتجربة السهلة.",
    },
  ],
  navbar: [],
  contact: {
  ...
  projects: [
    ...
    {
      title: "PeaceWatches",
      href: "https://peacewatches.com/",
      dates: "2025",
      active: true,
      category: "ecommerce",
      description:
        "PeaceWatches is a luxury watch brand store in Egypt featuring top global marques and curated collections for enthusiasts.",
      technologies: [
        "Next.js",
        "React",
        "Typescript",
    ...
    {
      title: "Zahw Honey",
      href: "https://zahw-honey-4pt6.vercel.app/",
      dates: "2025",
      active: true,
      category: "ecommerce",
      description:
        "Zahw is a premium Yemeni honey brand with an elegant online store and rich product storytelling.",
      technologies: [
        "Next.js",
        "React",
        "Typescript",
