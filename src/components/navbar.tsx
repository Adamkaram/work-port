                ...
                <TooltipTrigger asChild>
                  <Link
                    ...
                    className={cn(
                      ...
                      "size-12",
                      name === 'WhatsApp' && "text-[#25D366] hover:text-[#20BA5A] hover:bg-[#25D366]/10"
                    )}
                  >
                    <social.icon className={name === 'WhatsApp' ? "size-5" : "size-4"} />
                  </Link>
                </TooltipTrigger>
                <TooltipContent>
                  <p>{name === 'WhatsApp' ? (locale === 'ar' ? 'تواصل معنا' : 'Contact Us') : name}</p>
                </TooltipContent>
              </Tooltip>
            </DockIcon>
          ))}
